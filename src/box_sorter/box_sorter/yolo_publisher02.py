...
class YoloDetect(Node):
    def __init__(self):
        ...
        self.img_publisher_ = self.create_publisher(CompressedImage, 'yolo/compressed', 10)
        self.info_publisher_ = self.create_publisher(String, 'yolo/detected_info', 10)
